## Query : return populated array element
...
data modify storage ass:temp root.copy[{internal:{alive:0b}}].internal.matches set value 1b
data remove storage ass:temp root.copy[{internal:{matches:0b}}]

# Go to query loop setup
function ass:internal/query/unused/loop